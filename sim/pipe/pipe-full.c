...
int gen_f_pc()
{
    return (((((((ex_mem_curr->icode) == (I_MRMOVL)) & !
              (ex_mem_curr->takebranch)) & ((id_ex_curr->icode) == 
              (I_RMMOVL))) & ((if_id_curr->icode) == (I_JMP))) & (
          (if_id_curr->ifun) == (C_LE))) ? (if_id_curr->valp) : (((
            (ex_mem_curr->icode) == (I_JMP)) & !(ex_mem_curr->takebranch))
         & !(((mem_wb_curr->icode) == (I_RMMOVL)) & ((ex_mem_curr->ifun)
             == (C_LE)))) ? (ex_mem_curr->vala) : ((mem_wb_curr->icode) == 
        (I_RET)) ? (mem_wb_curr->valm) : (pc_curr->pc));
}
...
int gen_F_stall()
{
    return ((((id_ex_curr->icode) == (I_MRMOVL) || (id_ex_curr->icode) == 
          (I_POPL)) & (((id_ex_curr->destm) == (id_ex_next->srcb)) | (!(
...
int gen_D_bubble()
{
    return (((((id_ex_curr->icode) == (I_JMP)) & !(ex_mem_next->takebranch)
          ) & !((((mem_wb_curr->icode) == (I_MRMOVL)) & (
              (ex_mem_curr->icode) == (I_RMMOVL))) & ((id_ex_curr->ifun)
             == (C_LE)))) | (!(((id_ex_curr->icode) == (I_MRMOVL) || 
            (id_ex_curr->icode) == (I_POPL)) & (((id_ex_curr->destm) == 
              (id_ex_next->srcb)) | (!((if_id_curr->icode) == (I_RMMOVL)
                 || (if_id_curr->icode) == (I_PUSHL)) & (
                (id_ex_curr->destm) == (id_ex_next->srca))))) & ((I_RET)
...
int gen_E_bubble()
{
    return (((((id_ex_curr->icode) == (I_JMP)) & !(ex_mem_next->takebranch)
          ...
          (id_ex_curr->icode) == (I_POPL)) & (((id_ex_curr->destm) == 
            (id_ex_next->srcb)) | (!((if_id_curr->icode) == (I_RMMOVL) || 
              (if_id_curr->icode) == (I_PUSHL)) & ((id_ex_curr->destm) == 
              (id_ex_next->srca))))));
}
