...
# 1. Implemented load forwarding

# 2. Implemented the iaddl instruction, because it is used in ncopy
# stage    iaddl V, rB
...
# 3. Implemented a better jump prediction under a special
# instruction pattern:
# opl
# mrmovl
# rmmovl
